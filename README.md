...
This is Valkinsenn's personal project template for [Svelte](https://svelte.dev) apps, modified from its <a href="https://github.com/sveltejs/template" target="_blank">original version</a>. It now lives [here](https://github.com/Valkinsenn/svelte-template).
